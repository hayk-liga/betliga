  ...
  return (
    <div className="px-4 sm:px-5 py-4">
      ...
      <div className="bg-bg-card border border-border rounded-xl p-8 text-center">
        <Plus size={48} className="text-accent mx-auto mb-4" />
        <h2 className="text-xl font-bold text-text-primary mb-2">Deposit Funds</h2>
        <p className="text-text-secondary">Deposit crypto to your account. Multiple currencies supported.</p>
      </div>
    </div>
  )
}
