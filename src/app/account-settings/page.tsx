  ...
  return (
    <div className="px-4 sm:px-5 py-4">
      ...
      <div className="bg-bg-card border border-border rounded-xl p-8 text-center">
        ...
        <h2 className="text-xl font-bold text-text-primary mb-2">Account Settings</h2>
        <p className="text-text-secondary">Configure your account preferences, notifications, and security.</p>
      </div>
    </div>
  )
}
