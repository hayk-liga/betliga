  ...
  return (
    <div className="px-4 sm:px-5 py-4">
      <div className="flex items-center gap-3 mb-5">
        ...
        <h1 className="text-lg font-bold text-text-primary">Sportsbook</h1>
      </div>

      <div className="bg-bg-card border border-border rounded-xl p-8 text-center">
        <Trophy size={48} className="text-accent mx-auto mb-4" />
        <h2 className="text-xl font-bold text-text-primary mb-2">Sportsbook Coming Soon</h2>
        <p className="text-text-secondary">Bet on your favorite sports events with crypto. Stay tuned!</p>
      </div>
    </div>
  )
}
